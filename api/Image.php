	...
	private function image_constrain_gd($src_file, $dst_file, $max_w, $max_h, $watermark=null, $watermark_offet_x=0, $watermark_offet_y=0, $watermark_opacity=1)
	{
		...
		*/
		...
		if ($src_colors > 0 && $src_colors <= 256)
			...
			$dst_img = imagecreate($max_w, $max_h); //edit1
		else
			//$dst_img = imagecreatetruecolor($dst_w, $dst_h);
			$dst_img = imagecreatetruecolor($max_w, $max_h); //edit2
		...
		elseif ($src_type === 'image/png')
	    {
			...
			$transparency = imagecolorallocatealpha($dst_img, 255, 255, 255, 127); //edit6
		...
		if (!imagecopyresampled($dst_img, $src_img, $xpos, $ypos, 0, 0, $new_width, $new_height, $src_w, $src_h)) //edit5
			return false;	
