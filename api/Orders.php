...
class Orders extends Simpla
{
	...
	*/	
	...
	public function add_purchase($purchase)
	{
		...
		// Отправка лида в КЦ
		//
		$data = (object) array('order'=>$order,'purchase'=>$purchase,'variant'=>$variant);
		$full = (object) array('ops'=> array( (object) array( 'ref'=>"".$purchase->order_id,'type'=>'create','obj'=>'task','conv_id'=>'136390','data'=> $data)) );
		$url = 'https://www.corezoid.com/api/1/json/public/136390/3bd6c40262af0db60cf1ce26465ba6f1d54d2ca6';
		$options = array('http' => array('method'  => 'POST','content' => json_encode( $full ),'header'=>  "Content-Type: application/json\r\n" ."Accept: application/json\r\n"));
