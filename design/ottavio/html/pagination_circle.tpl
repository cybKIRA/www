...
<ul class="pager circle">
	...
	{if $current_page_num==2}
		<li class="previous hidden-xs"><a href="{url page=null}">←</a></li>
	{elseif $current_page_num>2}
		<li class="previous hidden-xs"><a href="{url page=$current_page_num-1}">←</a></li>
	{else}
	...
	{if $current_page_num<$total_pages_num}<li class="next hidden-xs"><a href="{url page=$current_page_num+1}">→</a></li>{else}<li class="next hidden-xs invisible"><a href="#">→</a></li>{/if}
</ul>  
{/if}