		...
		if($this->request->method('post'))
		{
			...
			else
			{
				...
				// Удаление превью
  	    		...
  	    		{
  	    			$this->blog->delete_thumb($post->id);
  	    		}
				...
				// Загрузка превью
  	    		...
  	    		{
  	    			$this->blog->delete_image($post->id);   	    			
  	    			move_uploaded_file($thumb['tmp_name'], $this->root_dir.$this->config->posts_thumbs_dir.$thumb['name']);
  	    			$this->blog->update_post($post->id, array('thumb'=>$thumb['name']));
  	    		}
