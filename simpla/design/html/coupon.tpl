	...
	<div id="column_left">
		...
		<div class="block layer">
			<ul>
				...
				<!-- GLOOBUS 2016-05-25 чекбокс, означающий что купон этот для определенных товаров -->
				<li>
					<label class=property for="of_product"></label>
					<input type="checkbox" name="of_product" id="of_product" value="1" {if $coupon->of_product==1}checked{/if}> <label for="of_product">на определенный продукт</label>					
				</li>
			</ul>
		</div>
