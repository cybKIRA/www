...
$(function() {
	// Удаление превью
	$(".images a.delete_thumb").click( function() {
		$("input[name='delete_thumb']").val('1');
		$(this).closest("ul").fadeOut(200, function() { $(this).remove(); });
		return false;
	});
	
	// Удаление изображений
	$(".images a.delete_image").click( function() {
...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div id="column_right">
		<div class="block layer images">
			<h2>Превью записи на главной</h2>
			<input class='upload_image' name=thumb type=file>			
			<input type=hidden name="delete_thumb" value="">
			{if $post->thumb}
			<ul>
				<li>
					<a href='#' class="delete delete_thumb"><img src='design/images/cross-circle-frame.png'></a>
					<img src="../{$config->posts_thumbs_dir}{$post->thumb}" alt="" />
				</li>
			</ul>
			{/if}
		</div>
		...
		<div class="block layer images">
			<h2>Изображение записи</h2>
			<input class='upload_image' name=image type=file>			
			<input type=hidden name="delete_image" value="">
			{if $post->image}
			<ul>
				<li>
					<a href='#' class="delete delete_image"><img src='design/images/cross-circle-frame.png'></a>
	...
	<!-- Описагние товара -->
	<div class="block layer">
		<h2>Краткое описание для главной</h2>
		<textarea name="annotation_tiny" class='editor_small'>{$post->annotation_tiny|escape}</textarea>
	</div>
	
	<div class="block layer">
		<h2>Краткое описание для блога</h2>
